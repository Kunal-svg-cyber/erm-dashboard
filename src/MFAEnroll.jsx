  ...
  return (
    <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 6, padding: 20, maxWidth: 420 }}>
      ...
      {active ? (
        ...
        <div>
          <div style={{ background: "#FFFFFF", border: "1px solid var(--border)", padding: 12, borderRadius: 6, marginBottom: 12, display: "inline-block" }} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(qr, { USE_PROFILES: { svg: true, svgFilters: true } }) }} />
